...
const DOMManip = (()=>{
    ...
    const _getTasks = (offset)=>{
        let todaysTasks = [];
        const dayRequested = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date()),{days:offset}),"MM/dd/yyyy");
        ___WEBPACK_IMPORTED_MODULE_0__.projectFunctions.getAllProjects().forEach(proj=>{            
            proj.tasks.forEach(task=>{
                const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"]) (task.getDate(), "MM/dd/yyyy", new Date() )), "MM/dd/yyyy");
    ...
    const _getOverdueTasks = ()=>{
        let overdueTasks = [];
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date());
        ___WEBPACK_IMPORTED_MODULE_0__.projectFunctions.getAllProjects().forEach(proj=>{            
            proj.tasks.forEach(task=>{
                if((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"]) (task.getDate(), "MM/dd/yyyy", new Date()), today) && task.getComplete() == false){
    ...
    const _displayTaskInput = ()=>{
        ...
        const addTaskDate = _makeNewElement("input", "add-task-date-input", "add-task-info","Due Date",{type:"date"},{min:(0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), 1).toISOString().split("T")[0]});
    ...
    const _fillInTask = (task, taskNumber, index)=>{
        ...
        _EventHandler__WEBPACK_IMPORTED_MODULE_1__["default"].activateCheckbox(index);
        if(task.getComplete()){
    ...
    const getTaskInfo = (index, projectNumber)=>{
        ...
        return {name:formInfo[0].value,
                ...
                date: (formInfo[2].value ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(formInfo[2].value)),"MM/dd/yyyy") : ""),
    ...
    const displayEditTask = e=>{
        ...
        const editTaskDate = _makeNewElement("input", "edit-task-date-input", "edit-task-info","Due Date",{type:"date"}, {value:new Date(editTask.getDate()).toISOString().split("T")[0]}, {min:(0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), 1).toISOString().split("T")[0]});
    ...
    const showToday = (e)=>{
        ...
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date()),"MM/dd/yyyy");
        const mainDisplay = getElement("#main-display");
...
const EventHandler = (()=>{
    ...
    const activateCheckbox = index=>{
        _DOMManip__WEBPACK_IMPORTED_MODULE_0__["default"].getElements(".task-checkbox")[index].addEventListener("click", _index__WEBPACK_IMPORTED_MODULE_1__.projectFunctions.toggleTaskComplete);
    };
...
const projectFunctions = (()=>{
    ...
    const addTask = (e)=>{
        ...
        if(goodTask){
            ...
            _DOMManip__WEBPACK_IMPORTED_MODULE_1__["default"].updateTaskList(newTask.number, newTaskInfo.project, newTaskInfo.number);
            _dataStorage__WEBPACK_IMPORTED_MODULE_4__["default"].saveData();
        }
    };
    ...
    const confirmTaskEdit = (e)=>{
        ...
        const index = _DOMManip__WEBPACK_IMPORTED_MODULE_1__["default"].getTaskIndex(e);
        const editTaskInfo = _DOMManip__WEBPACK_IMPORTED_MODULE_1__["default"].getTaskInfo(editTask, editProject);
        ...
        if(goodTask){
            ...
            _DOMManip__WEBPACK_IMPORTED_MODULE_1__["default"].updateTaskList(editTask, editProject, index);
            _dataStorage__WEBPACK_IMPORTED_MODULE_4__["default"].saveData();
        }
    };
