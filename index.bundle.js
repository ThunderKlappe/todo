...
const DOMManip = (()=>{
    ...
    const _displayTaskInput = ()=>{
        ...
        const addTaskDate = _makeNewElement("input", "add-task-date-input", "add-task-info","Due Date",{type:"date"},{min:((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date())).toISOString().split("T")[0]});
    ...
    const _fillInDays = (numberOfDays)=>{
        ...
        for(let i = 1; i <= numberOfDays; i++){
            ...
            if(displayedTask){
                _insertAfter(_makeNewElement("div", `day-${i}-away-label`, "day-away-label", (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date()),{days:i}),"MM/dd/yyyy")), 
    ...
    const getTaskInfo = (index, projectNumber)=>{
        ...
        return {name:formInfo[0].value,
                ...
                date: (formInfo[2].value ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(formInfo[2].value)),"MM/dd/yyyy") : ""),
    ...
    const displayEditTask = e=>{
        ...
        const editTaskDate = _makeNewElement("input", "edit-task-date-input", "edit-task-info","Due Date",{type:"date"}, {value:new Date(editTask.getDate()).toISOString().split("T")[0]}, {min:((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date())).toISOString().split("T")[0]});
    ...
    const showProject = (e)=>{
        ...
        _displayTitle();
        _EventHandler__WEBPACK_IMPORTED_MODULE_1__["default"].activateProjectButtons();
        ___WEBPACK_IMPORTED_MODULE_0__.projectFunctions.getAllProjects()[projectNumber].tasks.forEach((task, index) => _fillInTask(task, index, index));
        _displayTaskInput();
    };
