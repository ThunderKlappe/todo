...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/subDays/index.js");
...
const DOMManip = (()=>{
    ...
    const _getTodaysTasks = ()=>{
        ...
        ___WEBPACK_IMPORTED_MODULE_0__.projectFunctions.getAllProjects().forEach(proj=>{            
            proj.tasks.forEach(task=>{
                if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"]) (task.getDate(), 'MM/dd/yyyy', new Date() ))){
    ...
    const _displayTaskInput = ()=>{
        ...
        const addTaskDate = _makeNewElement('input', 'add-task-date-input', 'add-task-info','Due Date',{type:'date'},{min:(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 1).toISOString().split('T')[0]});
    ...
    const getTaskInfo = (index)=>{
        ...
        return {name:formInfo[0].value,
                ...
                date: (formInfo[2].value ? (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(formInfo[2].value)),'MM/dd/yyyy') : ''),
    ...
    const toggleTaskComplete = (e) =>{
        ...
        ___WEBPACK_IMPORTED_MODULE_0__.projectFunctions.toggleTaskComplete(e);
    ...
    const displayEditTask = e=>{
        ...
        const editTaskDate = _makeNewElement('input', 'edit-task-date-input', 'edit-task-info','Due Date',{type:'date'}, {value:new Date(editTask.getDate()).toISOString().split('T')[0]}, {min:(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), 1).toISOString().split('T')[0]});
    ...
    const showToday = (e)=>{
        ...
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date()),'MM/dd/yyyy');
        const mainDisplay = getElement('#main-display');
...
const EventHandler = (()=>{
    ...
    const activateCheckbox = index=>{
        _DOMManip__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.task-checkbox')[index].addEventListener('click', _DOMManip__WEBPACK_IMPORTED_MODULE_0__["default"].toggleTaskComplete)
    }
...
const projectFunctions = (()=>{
    ...
    const addTask = (e)=>{
        ...
        if(goodTask){
            _allProjects[newTaskInfo.project].tasks.push(new _Task__WEBPACK_IMPORTED_MODULE_2__.Task(newTaskInfo.name, newTaskInfo.description, 
