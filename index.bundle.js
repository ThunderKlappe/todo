...
const EventHandler = (()=>{
    ...
    const activateSides = ()=>{
        ...
        _DOMManip__WEBPACK_IMPORTED_MODULE_0__["default"].getElements('.task-side-label').forEach(ele => ele.addEventListener('click', _DOMManip__WEBPACK_IMPORTED_MODULE_0__["default"].showToday))
    }
